...
public class UrlParams {
    ...
    public String getInputCertNoTime() {
        return inputCertNoTime;
    }

    public void setInputCertNoTime(String inputCertNoTime) {
        this.inputCertNoTime = inputCertNoTime;
    }

    public String getInputSiteNoTime() {
        return inputSiteNoTime;
    }

    public void setInputSiteNoTime(String inputSiteNoTime) {
        this.inputSiteNoTime = inputSiteNoTime;
    }
